...
const AddBusinessForm: React.FC<AddBusinessFormProps> = ({ isOpen, onClose }) => {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button 
                type="submit"
                disabled={addBusiness.isPending || isUploading}
              >
                {(addBusiness.isPending || isUploading) && (
